 ...
 */
public class DirectoryClasspathContainerPage extends WizardPage 
     ...
     */
    public DirectoryClasspathContainerPage() {
    ...
    public IClasspathEntry getSelection() {
        ...
        if(dir.equals("")) {
            dir = DirectoryClasspathContainer.ROOT_DIR;
        }
        IPath containerPath = DirectoryClasspathContainer.ID.append( "/" + dir + "/" + 
                                                                   getExtValue());
