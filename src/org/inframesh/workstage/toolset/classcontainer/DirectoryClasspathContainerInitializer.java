 ...
 */
public class DirectoryClasspathContainerInitializer extends ClasspathContainerInitializer {
    ...
    public void initialize(IPath containerPath, IJavaProject project) throws CoreException {
        DirectoryClasspathContainer container = new DirectoryClasspathContainer( containerPath, project );
