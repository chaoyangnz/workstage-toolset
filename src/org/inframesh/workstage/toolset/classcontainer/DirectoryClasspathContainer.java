package org.inframesh.workstage.toolset.classcontainer;
 ...
 */
public class DirectoryClasspathContainer implements IClasspathContainer {
    public final static Path ID = new Path("org.inframesh.workstage.toolset.classcontainer.DIR_CLASSPATH_CONTAINER");
    ...
    private FilenameFilter _dirFilter = new FilenameFilter() {
        ...
        public boolean accept(File dir, String name) {
            ...
            if(_exts.contains(nameSegs[nameSegs.length-1].toLowerCase())) {
                return true;
            }           
            return false;
        }
     ...
     */
    public DirectoryClasspathContainer(IPath path, IJavaProject project) {
        _path = path;
        ...
        _desc = MessageFormat.format("Directory Libraries [/{0}]", path);
    }
