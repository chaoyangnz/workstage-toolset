 ...
 *******************************************************************************/
package org.inframesh.eclipse.jface.preference;
 ...
 * </p>
 */
public class StringFieldEditorEx extends FieldEditor {
     ...
     * @since 2.0
     */
    public StringFieldEditorEx(String name, String labelText, int width,
     ...
     * @param parent the parent of the field editor's control
     */
    public StringFieldEditorEx(String name, String labelText, Composite parent) {
    ...
    protected void doFillIntoGrid(Composite parent, int numColumns) {
        getLabelControl(parent).setLayoutData(new GridData(GridData.BEGINNING, GridData.BEGINNING, false, false));
